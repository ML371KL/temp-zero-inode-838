/*
  Монитор Bitcoin v2 — консервативный сборщик режимного снимка Bitcoin.
...
function compute(){
  ...
  // ценой $131k; история переносится вперёд на весь срок хранения, поэтому мусор жил неделю, а
